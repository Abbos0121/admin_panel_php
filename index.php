...
Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. 
	...
	<div class="news">
		<div class="container">
			<div class="col-md-3">
				...
				<div class="widget">
					<img src="assets/img/calendaar.jpg" alt="">
				</div>
			</div>
			<div class="col-md-9">
				<div class="row">
					<div class="col-md-4">
						<div class="news_box">
							<div class="img"><img src="assets/img/pict1.jpg" alt=""></div>
	...
	<div class="gal_slider">
		<div class="item">
			<a href="assets/img/mpict1.jpg" data-lightbox="roadtrip" data-title="Lorem ipsum dolor sit amet">
				<span class="caption">Lorem ipsum dolor sit amet</span>
				<img src="assets/img/mpict1.jpg" alt="">
			</a>
			<a href="assets/img/mpict1.jpg" data-lightbox="roadtrip" data-title="Lorem ipsum dolor sit amet">
				<span class="caption">Lorem ipsum dolor sit amet</span>
				<img src="assets/img/mpict1.jpg" alt="">
		...
		<div class="item">
			<a href="assets/img/mpict1.jpg" data-lightbox="roadtrip" data-title="Lorem ipsum dolor sit amet">
				<span class="caption">Lorem ipsum dolor sit amet</span>
				<img src="asstes/img/mpict1.jpg" alt="">
			</a>
			<a href="assets/img/mpict1.jpg" data-lightbox="roadtrip" data-title="Lorem ipsum dolor sit amet">
				<span class="caption">Lorem ipsum dolor sit amet</span>
				<img src="assets/img/mpict1.jpg" alt="">
			...
			<div class="row">
				<div class="col-md-3">
					<a href="#" class="magazin">
						...
						<img src="assets/img/magazine.png" alt="">
					</a>
				</div>
				<div class="col-md-6">
					<div class="video">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="send_message.php" method="POST" class="support">
              <div class="title">Сўров жўнатиш</div>
              <div class="row">
                  <div class="col-md-12">
                      <input type="text" name="fullname" placeholder="Исм-шарифингиз" required>
